...
+ [Werken met headless formulieren - Concepten en veelgestelde vragen](understanding-headless-forms.md)
...
+ Aan de slag met de startkit{#get-started}
   ...
   + [Aangepaste componenten gebruiken om een koploze vorm te genereren](developing-for-headless-forms-using-your-own-components.md)
   + [Gebeurtenissen gebruiken om formuliergegevens te verwerken en te verzenden](use-events-to-handle-and-submit-form-data.md)
   + [Aanbevolen werkwijzen voor mobiele formulieren](mobile-forms-best-practices.md)

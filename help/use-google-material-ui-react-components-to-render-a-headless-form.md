...
## &#x200B;1. UI voor Google-materiaal installeren
...
## &#x200B;2. Aangepaste React-componenten maken

Laten wij een douanecomponent tot stand brengen die de standaard ](https://spectrum.adobe.com/page/text-field/) component van de tekstinput [ met de [ Materiële UI van Google component ](https://mui.com/material-ui/react-text-field/) vervangt.

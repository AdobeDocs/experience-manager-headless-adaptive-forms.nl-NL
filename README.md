...
Adobe is verheugd over de bijdragen van de gemeenschap en van Adobe-medewerkers van buiten de documentatieteams.
...
Als u deel van de gemeenschap van Adobe bent en een nieuw artikel wilt tot stand brengen of belangrijke veranderingen voorstellen, open een kwestie in de Opslagplaats van de Git **Kwesties** tabel. Dit begint een gesprek met het documentatieteam. Als u eenmaal akkoord bent gegaan met een abonnement, moet u samenwerken met een medewerker om die nieuwe inhoud te helpen overbrengen via een combinatie van werk in de openbare en particuliere opslagruimten.
...
Technisch schrijvers, programmamanagers en productteamontwikkelaars die technische documenten van Experience Cloud maken of bijwerken, moeten de privérepo gebruiken op `https://git.corp.adobe.com/AdobeDocs` .
...
* [ Grondbeginselen van de Prijsverlaging ](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github)
* [ Afdrukbare prijsdaling ](https://docs.github.com/en)
...
* **klaar om** samen te voegen: Klaar voor overzicht door het team van het trekkingsverzoek van Adobe.
